 ...
 * @param {string} opts.network[='livenet'] - The Alarmx network for this wallet.
 ...
 * @param {string} opts.unit - Alarmx unit used to format amounts in notifications.
 */
 ...
 * @param {string} [opts.network = 'livenet'] - The Alarmx network to estimate fee levels from.
 ...
 * @param {string} [opts.network = 'livenet'] - The Alarmx network for this transaction.
